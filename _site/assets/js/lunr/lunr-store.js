var store = [{
        ...
        "title": "컴퓨터 사이언스란",
        "excerpt":"목차 컴퓨터 사이언스의 기원 컴퓨터 사이언스의 정의 컴퓨터 사이언스의 주요분야 컴퓨터 사이언스의 발전 컴퓨터 사이언스란? 컴퓨터 사이언스의 기원 컴퓨터 사이언스는 컴퓨터라고 하는 기기에 대한 연구라고 할 수 있다. 컴퓨터 사이언스의 현대적인 기원은 1940년대에 최초로 출현한 디지털 컴퓨터들의 등장과 1930년대에 이와는 별도로 형성된 계산기기들에 대한 적절한 수학적 모델에 있다고 할 수...","categories": ["컴퓨터 사이언스","Uncategorized"],
        "tags": ["CS"],
        "url": "/%EC%BB%B4%ED%93%A8%ED%84%B0%20%EC%82%AC%EC%9D%B4%EC%96%B8%EC%8A%A4/uncategorized/CS01/",
        "teaser": null
      }]
